...
#r "nuget: Philadelphia.Common, 0.19.11.1"
#r "nuget: Philadelphia.CodeGen.ForClient, 0.19.11.1"
...
#r "../Philadelphia.Tests.Domain/bin/Debug/netcoreapp2.2/Philadelphia.Tests.Domain.dll"

Philadelphia.CodeGen.ForClient.ServiceInvokerGenerator.GenerateCode(
    "Services.cs",
    typeof(Philadelphia.Tests.Domain.Dummy).Assembly,
    "Philadelphia.Tests.Client");
